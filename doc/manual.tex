...
\begin{itemize}
    \item  In \secR{details} we give a description of the module organization of \ccnsim\ together with a brief description of the most important parameters that describe the simulation.
    \item In \secR{extend}  there is a more technical description of \ccnsim, in terms of class implementation and design choices. 
    \item \secR{practice} reports a brief \ccnsim\ tutorial. We will show how to simulate and extending \ccnsim. 
    \item Finally, \secR{perf} shows some performance of the tool, its current issues, and further developments.
\end{itemize}
