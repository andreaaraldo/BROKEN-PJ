 ...
 *
 */
#ifndef COSTPROBCOINCORR_POLICY_H_
#define COSTPROBCOINCORR_POLICY_H_
...
class Costprobcoincorr: public Costprobcoin{
    public:		
		Costprobcoincorr(double average_decision_ratio_):
		...
		virtual double compute_correction_factor(){
			return average_decision_ratio / (weights[1] + weights[2]*priceratio);
		}
};
//<//aa>
#endif
