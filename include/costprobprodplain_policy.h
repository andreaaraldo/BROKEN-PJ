 ...
 *
 */
#ifndef COSTPROBPRODPLAIN_POLICY_H_
#define COSTPROBPRODPLAIN_POLICY_H_
...
class Costprobprodplain: public Costprobprod{
    public:
		Costprobprodplain(double average_decision_ratio_):
		...
		virtual double compute_correction_factor(){
			return average_decision_ratio / (double) pow(priceratio,xi) ;
		}
