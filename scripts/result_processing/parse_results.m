...
decision_list={"lce","fix0.01","costprob0.02"}; % The decision plocies that I want to plot
...
fixed_variable_names_additional = {"priceratio"};
...
input_data.fixed_variable_values_additional = \
			eval( [input_data.fixed_variable_names_additional{1},"_list"] );
...
metric_vs_priceratio(input_data);
